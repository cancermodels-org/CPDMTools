#' Create CTG Dose-Response Curve Plot
#'
#' @param ctg_list A Description
#' @param treat_name A Description
#' @param x_scale A Description
#' @param display_type A Description
#' @param sub_title A Description
#' @param y_axis_title A Description
#' @param make_interactive A Description
#' @param x_limits A Description
#' @param x_axis_breaks A Description
#' @param n_x_axis_breaks A Description
#' @param y_limits A Description
#' @param y_axis_breaks A Description
#' @param n_y_axis_breaks A Description
#' @param x_axis_text_size A Description
#' @param y_axis_text_size A Description
#' @param x_axis_title_size A Description
#' @param y_axis_title_size A Description
#' @param plot_title_size A Description
#' @param geom_point_size A Description
#' @param geom_line_width A Description
#'
  ...
  if (display_type == "se_bars") {
    ...
    ctg_summary <- data_long %>%
      ...
      dplyr::summarize(
        ...
        se_value = stats::sd_value / sqrt(n()),
